  ...
  return (
    <BlogContainer home={true} posts={posts}>
      <div className="text-white p-6 md:p-8 lg:p-12">
        ...
        {/* Featured Post */}
        <Card className="border-zinc-800 hover:border-zinc-400 mb-16 overflow-hidden rounded-2xl transition-colors">
      ...
      <footer className="mt-16 flex items-center justify-between border-t border-neutral-800 pt-4 px-6 md:px-8 lg:px-12">
